...
const socials = [
  { name: 'WhatsApp',  href: 'https://web.whatsapp.com/send?phone=919591066613&text=', handle: '+91 9591066613', color: '#25D366', icon: <WAIcon /> },
        ...
        <div className="container">
          <div className={styles.grid}>
            <div className={styles.info}>
              ...
              <a href="https://web.whatsapp.com/send?phone=919591066613&text=Hi%2C%20I%27d%20like%20to%20discuss%20a%20project." target="_blank" rel="noopener noreferrer" className={styles.whatsappBtn}>
