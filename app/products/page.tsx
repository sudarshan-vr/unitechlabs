...
export const metadata: Metadata = {
  ...
  description: 'Explore UnitechLabs products: AI-powered AgriTech systems, managed web hosting, the Craftuary social platform, and enterprise workflow automation built on n8n.',
...
const products = [
  ...
  { id: '03', name: 'Craftuary Global', category: 'Social Platform', description: 'A community-based social media platform for creators of every kind — IT enthusiasts, artists, meme makers, artisans — sharing their craft with the world.', features: ['Creator Profiles', 'Community Feed', 'Media Sharing', 'Cross-platform', 'Monetisation Tools'], href: '/contact', cta: 'Learn More', external: false },
